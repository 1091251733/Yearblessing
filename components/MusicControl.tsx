...
const MusicControl: React.FC = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleMusic}
        className={`absolute top-4 right-4 z-50 p-3 rounded-full border border-white/30 backdrop-blur-sm transition-all duration-700 ${
          isPlaying ? "bg-yellow-500/80 rotate-180 scale-110" : "bg-black/20"
        }`}
      >
        <div
